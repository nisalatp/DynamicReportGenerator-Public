...
- **Reference**
  - [AST Reference](reference/ast-reference.md)

- **Examples — Blade (AlpineJS)**
  - [Schema Discovery](examples/blade/schema-discovery.md)
  - [Build Query](examples/blade/build-query.md)
  - [Save Query](examples/blade/save-query.md)
...
- **Examples — Vue 3**
  ...
  - [Build Query](examples/vue/build-query.md)
  - [Save Query](examples/vue/save-query.md)
...
- **Examples — React**
  ...
  - [Build Query](examples/react/build-query.md)
  - [Save Query](examples/react/save-query.md)
...
- **Examples — Java**
  ...
  - [Build Query](examples/java/build-query.md)
  - [Save Query](examples/java/save-query.md)
...
- **Examples — MCP (AI Integration)**
  ...
  - [Build Query](examples/mcp/build-query.md)
  - [Save Query](examples/mcp/save-query.md)
...
- **Links**
  ...
  - [![Packagist](https://img.shields.io/badge/Packagist-package-F28D1A?logo=packagist&style=flat-square)](https://packagist.org/packages/nisalatp/dynamicreportgenerator)
