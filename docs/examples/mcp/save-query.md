# Save Query Example: AI Integration (Model Context Protocol)
...
This example demonstrates how an AI Agent can save a complex report configuration into the user's library using the Model Context Protocol (MCP).
