# Build Query Example: AI Integration (Model Context Protocol)
...
This example demonstrates how to integrate the Dynamic Report Generator with an AI Agent using the **Model Context Protocol (MCP)**. 

> [!IMPORTANT]
> Please refer to the [AST Reference Guide](reference/ast-reference) for the complete, definitive constraints and validation rules of the payload structure.
