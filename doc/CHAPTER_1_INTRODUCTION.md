...
4. **Data Democratization & UX Abstraction**: To build a self-serve reporting engine that empowers any employee to generate their own reports securely. This includes developing "Virtual Attributes" (e.g., a "Total Sales" checkbox) that hide complex subquery logic behind a simple 1D interface.
